...
"BVC", "EOR", "ERR", "ERR", "*NOP", "EOR", "LSR", "ERR", "CLI", "EOR", "*NOP", "ERR", "*NOP", "EOR", "LSR", "ERR", 
"RTS", "ADC", "ERR", "ERR", "*NOP", "ADC", "ROR", "ERR", "PLA", "ADC", "ROR", "ERR", "JMP", "ADC", "ROR", "ERR", 
"BVS", "ADC", "ERR", "ERR", "*NOP", "ADC", "ROR", "ERR", "SEI", "ADC", "*NOP", "ERR", "*NOP", "ADC", "ROR", "ERR", 
...
&relative_BVC, &indirectY_EOR, NULL, NULL, &zeropageX_NOP, &zeropageX_EOR, &zeropageX_LSR, NULL, &implied_CLI, &absoluteY_EOR, &implied_NOP, NULL, &absoluteX_NOP, &absoluteX_EOR, &absoluteX_LSR, NULL, 
...
&relative_BVS, &indirectY_ADC, NULL, NULL, &zeropageX_NOP, &zeropageX_ADC, &zeropageX_ROR, NULL, &implied_SEI, &absoluteY_ADC, &implied_NOP, NULL, &absoluteX_NOP, &absoluteX_ADC, &absoluteX_ROR, NULL, 
&immediate_NOP, &indirectX_STA, &immediate_NOP, NULL, &zeropage_STY, &zeropage_STA, &zeropage_STX, NULL, &implied_DEY, &immediate_NOP, &implied_TXA, NULL, &absolute_STY, &absolute_STA, &absolute_STX, NULL, 
